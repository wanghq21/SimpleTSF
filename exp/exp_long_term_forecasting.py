...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def test(self, setting, test=0):
        ...
        f.write(setting + "  \n")
        f.write('mse:{}, mae:{}, patch:{}, dropout:{}, d2:{}, lr:{}, --down_sampling_layers:{}, channel_function:{}'.format(mse, mae, self.args.patch, self.args.dropout, self.args.d2, self.args.learning_rate, self.args.down_sampling_layers, self.args.channel_function))
        f.write('\n')
        f.write('\n')
        f.close()

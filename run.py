...
if __name__ == '__main__':
    ...
    parser.add_argument('--patch', type=int, nargs='+', default=[4,12,24], help='patch')    
    ...
    # pathformer参数
    parser.add_argument('--layer_nums', type=int, default=3, help='dimension of core')
    parser.add_argument('--k', type=int, default=3, help='dimension of core')
    parser.add_argument('--num_experts_list', type=int, nargs='+', default=[3, 3, 3], help='dimension of core')
    parser.add_argument('--patch_size_list', type=int, nargs='+', default=[[4,8,16], [4,8,16], [4,8,16]],  help='dimension of core')
    parser.add_argument('--residual_connection', type=int, default=1, help='dimension of core')
    parser.add_argument('--revin', type=int, default=1, help='dimension of core')
